...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("VectorHub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			local x = game:GetService("HttpService"):JSONDecode(readfile("Hub/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
			local A = {}
...
local dj = bm:Window("ZAKO HUB", "", Enum.KeyCode.F1)
